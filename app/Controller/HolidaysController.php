 ...
 */
	public function add() {
		if ($this->request->is('post')) {
			$this->Holiday->create();
            $this->request->data['Holiday']['start'] = date('Y-m-d H:i:s', strtotime($this->request->data['Holiday']['start']));
            $this->request->data['Holiday']['end'] = date('Y-m-d H:i:s', strtotime($this->request->data['Holiday']['end']));
